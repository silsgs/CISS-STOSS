...
n_strands = 5         # minimum is 1
n_turns_step = 5      # min is 5, Davydov soliton
n_steps = 10          # total mol length will be calculated: (( Int.(vars["n_turns_step"]) * Int.(vars["n_steps"]) ) * 3.6 * (4.5/3)   # length in Angstrom)
temp = 300            # kelvin, K
relaxation_time = 0.005 # tau(s) hopping
